...
import {loginByOther} from 'mattermost-redux/actions/users';
...
function preRenderSetup(callwhendone) {
    ...
    // setUrl('http://www.sameview.com');
    // Client.setUrl('http://www.sameview.com');
    setUrl(window.serverUrl || getSiteURL());
    Client.setUrl(window.serverUrl || getSiteURL());
    // if (document.cookie.indexOf('MMAUTHTOKEN=') > -1) {
    //   Client4.setLocalStorageToken(getcookie('MMAUTHTOKEN'));
    // }
    let loginToken = Client4.getLocalStorageToken();
    if (document.cookie.indexOf('MMUSERID=') > -1 || loginToken || document.cookie.indexOf('MMAUTHTOKEN=') > -1) {
