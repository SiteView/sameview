...
export default class SidebarHeaderDropdown extends React.Component {
    ...
    render() {
        ...
        //         <a
        //             id='switchToItoss'
        //             href='http://demo.itoss.com.cn'
        //         >
        //             <FormattedMessage
        //                 id='navbar_dropdown.switchToItoss'
        //                 defaultMessage='Switch To ITOSS'
        //             />
        //         </a>
        //     </li>
        // );
        ...
        const keyboardShortcutsLink = (
            <li>
                <Link
                    target='_blank'
                    rel='noopener noreferrer'
                    to='https://about.3ren.com/default-keyboard_shortcut_link/'
                >
                    <FormattedMessage
        ...
        let switchToItossDivider = null;
        if (!sysAdminLink) {
            switchToItossDivider = <li className='divider'/>;
        }
