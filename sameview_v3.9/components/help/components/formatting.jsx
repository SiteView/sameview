// Copyright (c) 2016-present 3ren, Inc. All Rights Reserved.
...
export default class HelpFormatting extends React.Component {
    render() {
        ...
        message.push('```\n' + localizeMessage('help.formatting.codeBlock', 'code block') + '\n```');
        message.push(localizeMessage('help.formatting.syntax', '### Syntax Highlighting\n\nTo add syntax highlighting, type the language to be highlighted after the ``` at the beginning of the code block. 3ren also offers four different code themes (GitHub, Solarized Dark, Solarized Light, Monokai) that can be changed in **Account Settings** > **Display** > **Theme** > **Custom Theme** > **Center Channel Styles**'));
        ...
        message.push('![go syntax-highlighting](https://docs.3ren.com/_images/syntax-highlighting-github.PNG)');
        message.push(localizeMessage('help.formatting.solirizedDarkTheme', '**Solarized Dark Theme**'));
        message.push('![go syntax-highlighting](https://docs.3ren.com/_images/syntax-highlighting-sol-dark.PNG)');
        message.push(localizeMessage('help.formatting.solirizedLightTheme', '**Solarized Light Theme**'));
        message.push('![go syntax-highlighting](https://docs.3ren.com/_images/syntax-highlighting-sol-light.PNG)');
        message.push(localizeMessage('help.formatting.monokaiTheme', '**Monokai Theme**'));
        message.push('![go syntax-highlighting](https://docs.3ren.com/_images/syntax-highlighting-monokai.PNG)');
        ...
        message.push('`' + localizeMessage('help.formatting.linkEx', '[Check out 3ren!](https://about.3ren.com/)') + '`');
        message.push(localizeMessage('help.formatting.renders', 'Renders as:') + ' ' + localizeMessage('help.formatting.linkEx', '[Check out 3ren!](https://about.3ren.com/)'));
        message.push(localizeMessage('help.formatting.images', '## In-line Images\n\nCreate in-line images using an `!` followed by the alt text in square brackets and the link in normal brackets. Add hover text by placing it in quotes after the link.'));
        message.push('```\n' + localizeMessage('help.formatting.imagesExample', '![alt text](link "hover text")\n\nand\n\n[![Build Status](https://travis-ci.org/3ren/platform.svg?branch=master)](https://travis-ci.org/3ren/platform) [![Github](https://assets-cdn.github.com/favicon.ico)](https://github.com/3ren/platform)') + '\n```');
        message.push(localizeMessage('help.formatting.renders', 'Renders as:'));
        message.push(localizeMessage('help.formatting.imagesExample', '![alt text](link "hover text")\n\nand\n\n[![Build Status](https://travis-ci.org/3ren/platform.svg?branch=master)](https://travis-ci.org/3ren/platform) [![Github](https://assets-cdn.github.com/favicon.ico)](https://github.com/3ren/platform)'));
        message.push(localizeMessage('help.formatting.emojis', '## Emojis\n\nOpen the emoji autocomplete by typing `:`. A full list of emojis can be found [here](http://www.emoji-cheat-sheet.com/). It is also possible to create your own [Custom Emoji](http://docs.3ren.com/help/settings/custom-emoji.html) if the emoji you want to use doesn\'t exist.'));
