...
export default class HelpAttaching extends React.Component {
    render() {
        ...
        message.push(localizeMessage('help.attaching.supported', '#### Supported Media Types\nIf you are trying to preview a media type that is not supported, the file previewer will open a standard media attachment icon. Supported media formats depend heavily on your browser and operating system, but the following formats are supported by 3ren on most browsers:'));
        ...
        message.push(localizeMessage('help.attaching.limitations', '## File Size Limitations\n3ren supports a maximum of five attached files per post, each with a maximum file size of 50Mb.'));
