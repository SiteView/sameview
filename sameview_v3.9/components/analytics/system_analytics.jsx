                ...
                <div className='banner'>
                    <div className='banner__content'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage="To maximize performance, some statistics are disabled. You can re-enable them in config.json. See: <a href='https://docs.3ren.com/administration/statistics.html' target='_blank'>https://docs.3ren.com/administration/statistics.html</a>"
                        />
                    </div>
                </div>
            );
