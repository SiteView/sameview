                ...
                <div className='banner'>
                    <div className='banner__content'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage="Some statistics have been omitted because they put too much load on the system to calculate. See <a href='https://docs.3ren.com/administration/statistics.html' target='_blank'>https://docs.3ren.com/administration/statistics.html</a> for more details."
                        />
                    </div>
                </div>
            );
