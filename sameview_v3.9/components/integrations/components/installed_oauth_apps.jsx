            ...
            <BackstageList
                ...
                helpText={
                    <FormattedMessage
                        ...
                        defaultMessage='Create OAuth 2.0 applications to securely integrate bots and third-party applications with 3ren. Please see {link} to learn more.'
                        values={{
                            link: (
                                <a
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    href='https://docs.3ren.com/developer/oauth-2-0-applications.html'
                                >
                                    <FormattedMessage
