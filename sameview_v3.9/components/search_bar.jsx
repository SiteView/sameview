...
export default class SearchBar extends React.Component {
    ...
    render() {
        ...
        const switchToItossTooltip = (
            <Tooltip id='switchToItossTooltip'>
                <FormattedMessage
                    id='channel_header.switchToItoss'
        ...
        if (this.props.showMentionFlagBtns) {
            ...
            //                 style={{opacity: 1}}
            //             >
            //               <img src="/static/images/favicon/sitview.png" />
            //             </a>
            //         </OverlayTrigger>
            //     </div>
            // );
