...
export default class CreateComment extends React.Component {
    ...
    handleEmojiClick(emoji) {
        ...
        if (this.state.message === '') {
            ...
            const startMessage = ':' + emojiAlias + ': ';
            const enableAddButton = this.handleEnableAddButton(startMessage, this.state.fileInfos);
            this.setState({message: startMessage, enableAddButton});
        } else {
