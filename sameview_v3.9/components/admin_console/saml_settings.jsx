                ...
                <RemoveFileSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='Remove the certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when 三人即时通 is the Service Provider.'
                        />
                    }
                ...
                <FileUploadSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when 三人即时通 is the Service Provider.'
                        />
                    }
                    uploadingText={Utils.localizeMessage('admin.saml.uploading.certificate', 'Uploading Certificate...')}
                    disabled={!this.state.enable || !this.state.encrypt}
        ...
        return (
            <SettingsGroup>
                <div className='banner'>
                    <div className='banner__content'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='User attributes in SAML server, including user deactivation or removal, are updated in 3ren during user login. Learn more at: <a href=\"https://docs.3ren.com/deployment/sso-saml.html\">https://docs.3ren.com/deployment/sso-saml.html</a>'
                        />
                    </div>
                </div>
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, 3ren allows login using SAML. Please see <a href="http://docs.3ren.com/deployment/sso-saml.html" target="_blank">documentation</a> to learn more about configuring SAML for 3ren.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The URL where 三人即时通 sends a SAML request to start login sequence.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When false, 三人即时通 will not verify that the signature sent from a SAML Response matches the Service Provider Login URL. Not recommended for production environments. For testing only.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.saml.assertionConsumerServiceURLEx', 'Ex "https://<your-3ren-url>/login/sso/saml"')}
                    helpText={
                        <FormattedMessage
                            id='admin.saml.assertionConsumerServiceURLDesc'
                            defaultMessage='Enter https://<your-3ren-url>/login/sso/saml. Make sure you use HTTP or HTTPS in your URL depending on your server configuration. This field is also known as the Assertion Consumer Service URL.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When false, 三人即时通 will not decrypt SAML Assertions encrypted with your Service Provider Public Certificate. Not recommended for production environments. For testing only.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the SAML Assertion that will be used to populate the email addresses of users in 三人即时通.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the SAML Assertion that will be used to populate the username field in 三人即时通.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the first name of users in 三人即时通.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the last name of users in 三人即时通.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the nickname of users in 三人即时通.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the position of users in 三人即时通.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the language of users in 三人即时通.'
                        />
                    }
