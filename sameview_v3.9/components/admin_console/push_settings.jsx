...
export default class PushSettings extends AdminSettings {
    ...
    renderSettings() {
        ...
        //             defaultMessage='Please see <a href="http://docs.3ren.com/deployment/push.html#push-notifications-and-mobile-devices" target="_blank">documentation on push notifications</a> to learn more about setup options.'
        //         />
        //     );
        ...
        //             defaultMessage='Download <a href="https://itunes.apple.com/us/app/3ren/id984966508?mt=8" target="_blank">3ren iOS app</a> from iTunes. Download <a href="https://play.google.com/store/apps/details?id=com.3ren.3ren&hl=en" target="_blank">3ren Android app</a> from Google Play. Learn more about the <a href="http://docs.3ren.com/deployment/push.html#hosted-push-notifications-service-hpns" target="_blank">3ren Hosted Push Notification Service</a>.'
        //         />
        //     );
        ...
        //             defaultMessage='Download <a href="https://itunes.apple.com/us/app/3ren/id984966508?mt=8" target="_blank">3ren iOS app</a> from iTunes. Download <a href="https://play.google.com/store/apps/details?id=com.3ren.3ren&hl=en" target="_blank">3ren Android app</a> from Google Play. Learn more about the <a href="http://docs.3ren.com/deployment/push.html#test-push-notifications-service-tpns" target="_blank">3ren Test Push Notification Service</a>.'
        //         />
        //     );
        // } else {
        //     pushServerHelpText = (
        ...
        //             defaultMessage='Learn more about compiling and deploying your own mobile apps from an <a href="http://docs.3ren.com/deployment/push.html#enterprise-app-store-eas" target="_blank">Enterprise App Store</a>.'
        //         />
        //     );
        // }
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-8'>
                        ...
                        <FormattedHTMLMessage
                            ...
                            defaultMessage=' I understand and accept the 3ren Hosted Push Notification Service <a href="https://about.3ren.com/hpns-terms/" target="_blank">Terms of Service</a> and <a href="https://about.3ren.com/hpns-privacy/" target="_blank">Privacy Policy</a>.'
                        />
                    </div>
                </div>
            );
