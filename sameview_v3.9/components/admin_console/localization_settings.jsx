            ...
            <SettingsGroup>
                ...
                <MultiSelectSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            id='admin.general.localization.availableLocalesDescription'
                            defaultMessage='Set which languages are available for users in Account Settings (leave this field blank to have all supported languages available). '
                        />
                    }
                    noResultText={
                        <FormattedMessage
