            ...
            <div className='system-users__filter-row'>
                <div className='system-users__filter'>
                    <input
                        ...
                        placeholder={Utils.localizeMessage('搜索用户', '查询用户')}
                        onInput={doSearch}
                    />
                </div>
                <label>
                    ...
                    >
                        <option value={ALL_USERS}>{Utils.localizeMessage('所有用户', '所有用户')}</option>
                        <option value={NO_TEAM}>{Utils.localizeMessage('无团队', '无团队')}</option>
                        {teams}所有用户
                    </select>
                </label>
            </div>
