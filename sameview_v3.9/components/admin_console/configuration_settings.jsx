        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.service.siteURLExample', 'Ex "https://3ren.example.com:1234"')}
                    helpText={
                        <FormattedMessage
                            id='admin.service.siteURLDescription'
                            defaultMessage='The URL, including port number and protocol, that users will use to access 三人即时通. This setting is required.'
                        />
                    }
