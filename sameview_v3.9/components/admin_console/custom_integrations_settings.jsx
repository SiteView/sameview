            ...
            <SettingsGroup>
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            id='admin.service.cmdsDesc'
                            defaultMessage='When true, custom slash commands will be allowed.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, 三人即时通 can act as an OAuth 2.0 service provider allowing 3ren to authorize API requests from external applications. See <a href="https://docs.3ren.com/developer/oauth-2-0-applications.html" target="_blank">documentation</a> to learn more.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, webhooks, slash commands and other integrations, such as <a href="https://docs.3ren.com/integrations/zapier.html" target="_blank">Zapier</a>, will be allowed to change the username they are posting as. Note: Combined with allowing integrations to override profile picture icons, users may be able to perform phishing attacks by attempting to impersonate other users.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, webhooks, slash commands and other integrations, such as <a href="https://docs.3ren.com/integrations/zapier.html" target="_blank">Zapier</a>, will be allowed to change the profile picture they post with. Note: Combined with allowing integrations to override usernames, users may be able to perform phishing attacks by attempting to impersonate other users.'
                        />
                    }
