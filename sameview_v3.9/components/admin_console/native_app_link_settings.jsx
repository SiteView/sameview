    ...
    renderTitle() {
        return (
            <FormattedMessage
                ...
                defaultMessage='三人即时通 App Links'
            />
        );
    }
                ...
                <TextSetting
                    ...
                    label={
                        <FormattedMessage
                            ...
                            defaultMessage='三人即时通 Apps Download Page Link:'
                        />
                    }
                    helpText={
                        <FormattedMessage
                            id='admin.customization.appDownloadLinkDesc'
                            defaultMessage='Add a link to a download page for the 三人即时通 apps. When a link is present, an option to "Download 三人即时通 Apps" will be added in the Main Menu so users can find the download page. Leave this field blank to hide the option from the Main Menu.'
                        />
                    }
