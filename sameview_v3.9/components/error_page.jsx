...
export default class ErrorPage extends React.Component {
    ...
    linkFilter(link) {
        return link.startsWith('https://docs.3ren.com') || link.startsWith('https://forum.3ren.org');
    }
        ...
        if (this.props.location.query.type === ErrorPageTypes.LOCAL_STORAGE) {
            return (
                <FormattedMessage
                    ...
                    defaultMessage='Cannot Load 三人即时通'
                />
            );
        }
            ...
            return (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage='三人即时通 was unable to load because a setting in your browser prevents the use of its local storage features. To allow 三人即时通 to load, try the following actions:'
                    />
                    <ul>
                        <li>
                            <FormattedMessage
    ...
    renderLink() {
        ...
        if (!linkMessage) {
            linkMessage = Utils.localizeMessage('error.generic.link_message', 'Back to 三人即时通');
        }
