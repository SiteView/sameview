...
export default class CreatePost extends React.Component {
    ...
    sendMessage(post) {
        ...
        // post.message = Utils.getEmojiMessage(post.message);
        // return;
    ...
    handleChange(e) {
        const message = e.target.value !== undefined ? e.target.value : e.target.innerHTML;
    ...
    handleEmojiClick(emoji) {
        ...
        if (this.state.message === '') {
            ...
            // const msg = emoji.filename ? '<img alt=:' + emojiAlias + ': class="emoticon" title=:' + emojiAlias + ': src="/static/emoji/'+ emoji.filename +'.png" />' : (':' + emojiAlias + ': ');
            ...
            // const msg = emoji.filename ? '<img alt=:' + emojiAlias + ': class="emoticon" title=:' + emojiAlias + ': src="/static/emoji/'+ emoji.filename +'.png" />' : (':' + emojiAlias + ': ');
            // const newMessage = (/\s+$/.test(this.state.message)) ?
            //     this.state.message + msg + ' ' : this.state.message + ' ' + msg + ' ';
