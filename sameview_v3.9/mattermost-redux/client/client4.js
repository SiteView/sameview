...
export default class Client4 {
    ...
    getWebsocketUrl(){
      ...
      if (window.location.origin) {
          return window.location.port ? window.location.origin.replace(window.location.port, window.serverPort || "8068") : window.location.origin + ":8068";
      }
    ...
    loginByOther = async (loginId, password, token = '', deviceId = '') => {
        const body = {
            device_id: deviceId,
            login_id: loginId,
            password,
